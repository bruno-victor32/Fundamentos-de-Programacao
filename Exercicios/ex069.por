programa
{
	...
	/*Ex069: Faça um programa que crie uma rotina capaz de personalizar mensagens na tela do usuário*/
 ...
 * @POSICAO-CURSOR = 164; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {cont, 23, 17, 4}-{faixa, 7, 9, 5}-{borda, 6, 62, 5}-{quant, 6, 47, 5}-{txt, 6, 34, 3};
